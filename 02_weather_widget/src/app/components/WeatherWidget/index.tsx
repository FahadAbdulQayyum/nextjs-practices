...
export default function WeatherWidget() {
    ...
    return (
        ...
        //     'https://cdn.pixabay.com/photo/2021/04/28/23/58/ice-6215207_1280.jpg'
        //     )] bg-cover bg-center">

        <div className={`flex justify-center items-center h-screen
        ${weather && weather.temperature >= 25
                ?
                'bg-[url(https://media.istockphoto.com/id/2152193820/photo/fire-png-burning-flame-isolated-on-a-black-background.jpg?s=612x612&w=0&k=20&c=22mh-sgeJc9qJs7qVxwcTtoAX40SB0JV0mRdSOQnxko=)]'
                :
                'bg-[url(https://cdn.pixabay.com/photo/2021/04/28/23/58/ice-6215207_1280.jpg)]'
            } bg-cover bg-center`
        }>
