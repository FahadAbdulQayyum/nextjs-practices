...
export default function CountDownTimer() {
    ...
    return (
        ...
        // <div className="flex flex-col items-center justify-center h-screen bg-stone-700 dark:bg-gray-100">
        <div className="flex flex-col items-center justify-center h-screen bg-gray-100 dark:bg-gray-900">
            ...
            <div className="bg-white dark:bg-slate-600 shadow-lg rounded-lg p-9 w-full max-w-lg border border-orange-500 relative">
                ...
                <div className="text-9xl font-bold text-gray-800 dark:text-gray-200 mb-8 text-left">
                    {formatTime(timeLeft)}
                </div>
                ...
                <div className="flex flex-col justify-center gap-4 absolute right-4 top-20">
                    <Button
                        ...
                        variant="outline"
                        className="text-gray-800 dark:text-gray-200 order-1"
                    >
                        Set
                    </Button>
                    <Button
